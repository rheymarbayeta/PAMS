      ...
      <div className="max-w-md w-full mx-4">
        ...
        <div className="bg-white rounded-xl shadow-soft border border-slate-200 p-8 space-y-8">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="block w-full pl-10 pr-4 py-2.5 border border-slate-200 rounded-lg text-slate-900 placeholder-slate-400 bg-slate-50 focus:bg-white focus:border-slate-500 focus:ring-2 focus:ring-slate-200 transition-all duration-200 outline-none"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="block w-full pl-10 pr-10 py-2.5 border border-slate-200 rounded-lg text-slate-900 placeholder-slate-400 bg-slate-50 focus:bg-white focus:border-slate-500 focus:ring-2 focus:ring-slate-200 transition-all duration-200 outline-none"
          ...
          <p className="text-center text-xs text-slate-400">
            Municipality of Dalaguete &mdash; PAMS v1.0
          </p>
